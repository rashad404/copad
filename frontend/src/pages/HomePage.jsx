    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-indigo-50">
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-indigo-50 to-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative">
            {/* Timeline connector */}
            <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-1 bg-indigo-200 transform -translate-x-1/2" />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="flex items-center">
                <div className="w-12 h-12 rounded-full bg-indigo-600 mr-4"></div>
                <div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <motion.div 
            className="bg-gradient-to-r from-indigo-600 to-violet-600 rounded-2xl overflow-hidden shadow-xl"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            ...
            <div className="md:grid md:grid-cols-5">
              <div className="p-8 md:p-12 md:col-span-3 text-white">
                ...
                <div className="flex flex-wrap gap-4">
                  <Link to="/register" className="bg-white text-indigo-600 px-6 py-3 rounded-lg font-medium hover:bg-gray-100 transition-colors shadow-sm">
              ...
              <div className="hidden md:block md:col-span-2 bg-indigo-800 p-8">
                <div className="h-full flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-24 h-24 mx-auto bg-indigo-500 rounded-full flex items-center justify-center mb-4">
      ...
      <footer className="bg-white border-t border-gray-200 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 text-indigo-600 font-bold text-xl mb-4">
                <div className="relative">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-4">{t("home.footer.product")}</h3>
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-500 hover:text-indigo-600 text-sm">{t("home.footer.links.pricing")}</a></li>
                <li><a href="#" className="text-gray-500 hover:text-indigo-600 text-sm">{t("home.footer.links.faq")}</a></li>
              </ul>
            </div>
            
            <div>
              <h3 className="font-semibold text-gray-900 mb-4">{t("home.footer.company")}</h3>
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-500 hover:text-indigo-600 text-sm">{t("home.footer.links.about")}</a></li>
                <li><a href="#" className="text-gray-500 hover:text-indigo-600 text-sm">{t("home.footer.links.blog")}</a></li>
                <li><a href="#" className="text-gray-500 hover:text-indigo-600 text-sm">{t("home.footer.links.contact")}</a></li>
              </ul>
            </div>
            
            <div>
              <h3 className="font-semibold text-gray-900 mb-4">{t("home.footer.legal")}</h3>
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-500 hover:text-indigo-600 text-sm">{t("home.footer.links.privacy")}</a></li>
                <li><a href="#" className="text-gray-500 hover:text-indigo-600 text-sm">{t("home.footer.links.terms")}</a></li>
                <li><a href="#" className="text-gray-500 hover:text-indigo-600 text-sm">{t("home.footer.links.security")}</a></li>
              </ul>
            </div>
          </div>
