...
/*
 * Dates come from the shared date utility, which knows the Azerbaijani month
 * and weekday names the browser does not ship. Re-exported here so the booking
 * screens keep importing their wording from one place.
 */
export {
  monthTitle,
  weekdayHeadings,
